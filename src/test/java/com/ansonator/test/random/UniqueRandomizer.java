...
/**
 * This is intended to guarantee that all created instances are unique. It's close, but isn't actually doing that now. So, it's currently
 * only used as a marker to identify code where we require a uniqueness.
 *
 * @param <T>
 */
